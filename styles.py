...
div.st-key-stat_need_order_all button { border-color: rgba(234,88,12,0.45) !important; color: #fb923c !important; }
div.st-key-stat_need_order_priced button { border-color: rgba(245,158,11,0.4) !important; color: #fbbf24 !important; }
div.st-key-stat_need_order_unpriced button { border-color: rgba(168,162,158,0.35) !important; color: #d6d3d1 !important; }
div.st-key-stat_need_order_total button { border-color: rgba(34,197,94,0.4) !important; color: #4ade80 !important; }
div.st-key-stat_need_order_all button[kind="primary"] { background: rgba(234,88,12,0.16) !important; }
div.st-key-stat_need_order_priced button[kind="primary"] { background: rgba(245,158,11,0.16) !important; }
